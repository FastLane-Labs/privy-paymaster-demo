          ...
          {isError && hasAA24Error && (
            <div className="mt-2 p-2 bg-red-50 border border-red-200 rounded">
              ...
              <p className="text-xs mt-2 text-gray-600">
                Error code AA24 indicates a signature validation problem in ERC-4337. This usually
                means the signature was incorrectly generated or the account contract rejected it.
              </p>
            </div>
          )}
        </div>
