...
export function initShBundler(
  ...
  // Create a safe bundle client without any BigInt values in paymasterContext
  return createShBundler(
    createBundlerClient({
      ...
      paymasterContext: {
        ...
        // Note: Only include serializable values in paymasterContext
...
export function initBasicBundler(
  smartAccount: SmartAccount,
  publicClient: Client
): ShBundler {
