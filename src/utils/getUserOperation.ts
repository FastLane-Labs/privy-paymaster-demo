...
import { GetUserOperationHashParameters, UserOperation, GetUserOperationHashReturnType, EntryPointVersion } from "viem/account-abstraction";

export function getUserOperationHash<entryPointVersion extends EntryPointVersion>(
